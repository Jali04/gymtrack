...
const TR = {
  de: {
    ...
    colKm: 'km', colTime: 'Zeit', colPace: 'Tempo', colMin: 'Min', colLoad: 'Last', colHold: 'Zeit (s)', colDuration: 'Dauer', holdTimer: 'Zeit stoppen',
    ...
    confirmTitle: 'Bestätigen', confirmYes: 'Bestätigen', confirmNo: 'Abbrechen', confirmDeleteYes: 'Löschen',
    ...
    set: 'Satz', detailsNote: '⋯ Details / Notiz', applyLast: '↧ Übernehmen', appliedLast: '✓ Werte übernommen',
    restLabel: 'Pause', noSetsYet: 'Noch keine Sätze — „+ Satz" tippen', removeSet: 'Satz entfernen',
    wakeLockOn: 'Display bleibt beim Training an', wakeLockOff: 'Display-Sperre normal',
    restSoundOn: 'Pausen-Ton an', restSoundOff: 'Pausen-Ton aus', restore: 'Wiederherstellen',
  ...
  en: {
    ...
    colKm: 'km', colTime: 'Time', colPace: 'Pace', colMin: 'Min', colLoad: 'Load', colHold: 'Time (s)', colDuration: 'Duration', holdTimer: 'Time it',
    ...
    confirmTitle: 'Confirm', confirmYes: 'Confirm', confirmNo: 'Cancel', confirmDeleteYes: 'Delete',
    ...
    set: 'Set', detailsNote: '⋯ Details / Note', applyLast: '↧ Apply', appliedLast: '✓ Values applied',
    restLabel: 'Rest', noSetsYet: 'No sets yet — tap “+ Set”', removeSet: 'Remove set',
    wakeLockOn: 'Screen stays on during training', wakeLockOff: 'Screen lock normal',
    restSoundOn: 'Rest sound on', restSoundOff: 'Rest sound off', restore: 'Restore',
